...
QImage Image::img() const { return m_img; }

int Image::pxWidth() const { return m_imgSize.width(); }

int Image::pxHeight() const { return m_imgSize.height(); }

int Image::horzDpi() const { return m_horzDpi; }

int Image::vertDpi() const { return m_vertDpi; }

QString Image::ext() const { return m_ext; }

QString Image::contentType() const { return m_contentType; }

QByteArray Image::blob()
{
    if (m_blob.isEmpty()) saveBlob();
    return m_blob;
}
