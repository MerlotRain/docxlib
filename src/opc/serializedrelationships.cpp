...
QString SerializedRelationship::baseURI() const { return m_baseURI; }

QString SerializedRelationship::rId() const { return m_rId; }

QString SerializedRelationship::relType() const { return m_relType; }

QString SerializedRelationship::target() const { return m_target; }
...
bool SerializedRelationship::isExternal() const { return m_targetMode == Constants::EXTERNAL; }
...
SerializedRelationships *SerializedRelationships::loadFromData(const QString baseURI,
                                                               const QByteArray &relsXml)
{
    ...
    for (int i = 0; i < nodes.count(); i++)
    {
        ...
        rels->m_rels.append(SerializedRelationship(
                baseURI, ele.attribute(QStringLiteral("Id")), ele.attribute(QStringLiteral("Type")),
...
QVector<SerializedRelationship> SerializedRelationships::rels() const { return m_rels; }

int SerializedRelationships::count() const { return m_rels.count(); }
...
SerializedPart::SerializedPart(const PackURI &partName, const QString &contentType,
                               const QString &reltype, const QByteArray &blob,
                               const SerializedRelationships &srels)
    : m_partName(partName), m_contentType(contentType), m_reltype(reltype), m_blob(blob),
      m_srels(srels)
{
}

PackURI SerializedPart::partName() const { return m_partName; }

QString SerializedPart::contentType() const { return m_contentType; }

QString SerializedPart::relType() const { return m_reltype; }

QByteArray SerializedPart::blob() const { return m_blob; }
