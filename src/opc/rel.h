...
{
public:
    Relationship(const QString &rId, const QString &reltypet, const QString &targetRef,
                 Part *target, const QString &baseURI, bool external = false);
...
public:
    ...
    Relationship *addRelationship(const QString &reltype, const QString &targetRef, Part *target,
                                  const QString &rId, bool external = false);
