...
CT_Picture::CT_Picture(QDomDocument *dom, const QString &picId, const QString &fileName,
                       const QString &rId, int cx, int cy)
    : m_dom(dom)
{
    createElement(picId, fileName, rId, cx, cy);
}

QDomElement CT_Picture::element() const { return m_picEle; }

void CT_Picture::createElement(const QString &picId, const QString &fileName, const QString &rId,
                               int cx, int cy)
{
...
CT_Inline::CT_Inline(QDomDocument *dom, double cx, double cy, const QString &shapeId,
                     CT_Picture *pic)
    : m_dom(dom), m_pic(pic)
{
...
QDomElement CT_Inline::element() const { return m_inlineEle; }

CT_Inline::~CT_Inline() { delete m_pic; }
